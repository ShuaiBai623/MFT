...
%error('Tracker not configured! Please edit the tracker_MFT.m file.'); % Remove this line after proper configuration
...
tracker_command = generate_matlab_command('MFT()', {[tracker_repo_path, 'vot2018_main']});
